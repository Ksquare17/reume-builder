...
import { updateCertificate, addCertificate, deleteCertificate } from "../redux/certificateSlice";
...
console.log(certificates)
  const handleInputChange = (index, event) => {
    ...
    dispatch(updateCertificate({ index, field: name, value }));
  };
  ...
  const content = (
    <div>
      <p>1. Provide  description of the certificate.</p>
          </div>
  );
